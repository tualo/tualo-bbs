(function() {
  var Controller, EventEmitter, Net, StartPrintjob, StatusLight, StopPrintjob,
    ...
    Controller.prototype.open = function() {
      ...
      if (this.client === null) {
        ...
        this.client.on('close', function() {
          console.log('controller close', this.closeEventName);
          return me.emit('closed', this.closeEventName);
        });
        return this.client.on('end', function() {
