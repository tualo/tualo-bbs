(function() {
  ...
  module.exports = MSG2HSNEXTIMPRINT = (function(superClass) {
    ...
    function MSG2HSNEXTIMPRINT() {
      ...
      this.setMessageType(Message.SERVICE_NEXT_IMPRINT);
    }
    ...
    MSG2HSNEXTIMPRINT.prototype.readApplictiondata = function(data) {
      data.position = 0;
      this.job_id = data.readUInt();
      this.customer_id = data.readUInt();
      this.machine_no = data.readUInt();
      this.high_imprint_no = data.readUInt();
      this.low_imprint_no = data.readUInt();
      this.imprint_no = (this.high_imprint_no >> 32) + this.low_imprint_no;
      this.creationDate = data.readDate();
      this.printedDate = data.readDate();
      this.endorsement_id = data.readInt();
      this.town_circle_id = data.readUInt();
      this.mail_length = data.readInt();
      this.mail_height = data.readInt();
      this.mail_thickness = data.readInt();
      this.mail_weight = data.readUInt();
