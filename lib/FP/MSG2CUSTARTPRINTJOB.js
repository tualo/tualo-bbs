  ...
  module.exports = MSG2CUSTARTPRINTJOB = (function(superClass) {
    ...
    function MSG2CUSTARTPRINTJOB() {
      ...
      try {
        ...
        console.log('advert', this.advert.toString('base64'));
      } catch (error) {
        e = error;
        console.log(e);
      }
    ...
    MSG2CUSTARTPRINTJOB.prototype.readApplictiondata = function(data) {
      ...
      console.log('endorsement_text', this.endorsement_text);
    ...
    MSG2CUSTARTPRINTJOB.prototype.setApplictiondata = function(data) {
      ...
      position += 1;
      console.log('weightmode', position, ' value ', this.weightmode);
      ...
      console.log('ip data', this.imprint_channel_port, this.app_data.slice(position - this.imprint_channel_ip.length, position).toString('ascii'));
