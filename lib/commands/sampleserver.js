  ...
  module.exports = Sampleserver = (function(superClass) {
    ...
    Sampleserver.prototype.action = function(options, args) {
      ...
      if (args.port) {
        ...
        return this.server.listen(args.port, '127.0.0.1', (function(_this) {
          return function() {
    ...
    Sampleserver.prototype.debugConnections = function() {
    ...
    Sampleserver.prototype.onClientEnd = function(data) {
