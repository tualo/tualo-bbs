(function() {
  ...
  module.exports = HttpServer = (function(superClass) {
    ...
    HttpServer.prototype.expressStartSwitch = function(req, res) {
      var proc;
    ...
    HttpServer.prototype.expressStopSwitch = function(req, res) {
      var proc;
    ...
    HttpServer.prototype.expressResultState = function(req, res) {
    ...
    HttpServer.prototype.setResultState = function(state) {
