(function() {
  ...
  module.exports = HttpServer = (function(superClass) {
    ...
    HttpServer.prototype.openExpressServer = function() {
      ...
      app.get('/', (function(_this) {
        return function(req, res) {
          ...
          if (_this.start_without_printing_running === true) {
      ...
      app.all('/returnstate', this.expressReturnState.bind(this));
    ...
    HttpServer.prototype.expressReturnState = function(req, res) {
    ...
    HttpServer.prototype.setReturnState = function(state) {
      return fs.exists('/opt/grab/returnstate.txt', function(exists) {
        if (exists) {
          return fs.writeFile('/opt/grab/returnstate.txt', state, function(err) {
            if (err) {
              return console.log(err);
            }
          });
