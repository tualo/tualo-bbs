(function() {
  var Command, HttpServer, app, bbs, fs, http, mysql, path, sss, stats,
  ...
  module.exports = HttpServer = (function(superClass) {
    ...
    HttpServer.prototype.refreshForStopTimer = function() {
      ...
      return this.lastimprinttimer = setTimeout(this.refreshStopJob.bind(this), 45000);
    };
    ...
    HttpServer.prototype.expressStartJob = function(req, res) {
      ...
      try {
        if (me.lastState.print_job_active === 1) {
          return res.send(JSON.stringify({
            success: false,
            msg: "Es wird bereits ein Druckauftrag asugeführt"
          }));
        } else {
          bodymessage = {};
          try {
    ...
    HttpServer.prototype.getStatusTimed = function() {
      ...
      errorFN = (function(_this) {
        return function(errMessage) {
          ...
          return me.timer = setTimeout(me.getStatusTimed.bind(me), 30000);
        };
      })(this);
      closeFN = (function(_this) {
        return function(message) {
      ...
      doneFN = (function(_this) {
        return function(message) {
          ...
          return me.timer = setTimeout(me.getStatusTimed.bind(me), 5000);
        };
      })(this);
